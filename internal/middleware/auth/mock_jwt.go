...
func (m *MockTokenAuthentication) GenerateToken(arg0 int) (string, error) {
	m.ctrl.T.Helper()
...
func (m *MockTokenAuthentication) GetUserIdFromToken(arg0 string) int {
	m.ctrl.T.Helper()
...
func (mr *MockTokenAuthenticationMockRecorder) GetUserIdFromToken(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetUserIdFromToken", reflect.TypeOf((*MockTokenAuthentication)(nil).GetUserIdFromToken), arg0)
}
